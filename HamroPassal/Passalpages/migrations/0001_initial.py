    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carts_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Passalpages.carts_info')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.PositiveIntegerField(default=0)),
                ('checkOutInfos', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Passalpages.checkoutinfo')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Passalpages.product')),
            ],
        ),
        migrations.CreateModel(
